...
ALTER TABLE dlstorage_services.user_mirrors ADD INDEX `user_index` (`user_id`);
ALTER TABLE dlstorage_services.user_mirrors ADD UNIQUE `unique_user_meta_index` (user_id, singleton_id);
